"""
Evaluate the Llama-3-8B ARC-BPO 20% label-noise LoRA checkpoint on Modal.

Default model:
  ducthang1703/llama3-8b-arc-bpo-lora-noise20-16k
...
Run:
  modal run --detach modal_eval_llama_noisy20_lora.py::main

Print saved results:
  modal run modal_eval_llama_noisy20_lora.py::results
"""

import modal


APP_NAME = "tbpo-llama3-noisy20-lora-eval"
DEFAULT_MODEL = "ducthang1703/llama3-8b-arc-bpo-lora-noise20-16k"
DEFAULT_MODEL_LABEL = "llama3-8b-arc-bpo-lora-noise20-16k"
RUN_VERSION = "llama3-noisy20-16k-lora-a100-merge-vllm-oomsafe-v3"
...
def main(
    ...
    """Run the 3-task eval for the noisy 20% Llama LoRA adapter."""
    ...
    print(f"  Model:   {model_path}")
    print(
        "  Results: modal run modal_eval_llama_noisy20_lora.py::results "
